...
abstract class Model {
  ...
  private static $_dirsFunc = null; // php8 -> ?callable
  ...
  public static function setDir(string $dir): void {
    ...
    if (is_callable(self::$_dirsFunc)) {
      spl_autoload_unregister(self::$_dirsFunc);
    }
  ...
  public static function one(...$args): ?self { return Builder::create(null, static::class)->one(...$args); } // php8 -> return ?static
  public static function first(...$args): ?self { return Builder::create(null, static::class)->first(...$args); } // php8 -> return ?static
  public static function last(...$args): ?self { return Builder::create(null, static::class)->last(...$args); } // php8 -> return ?static
  public static function all(): array { return Builder::create(null, static::class)->all(); }

  public static function builder(?string $db = null): Builder { return Builder::create($db, static::class); }
  public static function select(string ...$args): Builder { return Builder::create(null, static::class)->select(...$args); }
  public static function order(string ...$args): Builder { return Builder::create(null, static::class)->order(...$args); }
  public static function byKey(string ...$keys): Builder { return Builder::create(null, static::class)->byKey(...$keys); }
  public static function limit(int $limit): Builder { return Builder::create(null, static::class)->limit($limit); }
  public static function offset(int $offset): builder { return Builder::create(null, static::class)->offset($offset); }
  public static function group(?string $group): Builder { return Builder::create(null, static::class)->group($group); }
  public static function having(?string $having): Builder { return Builder::create(null, static::class)->having($having); }
  public static function count(): ?int { return Builder::create(null, static::class)->count(); }

  public static function updates(array $sets = []): ?int { return Builder::create(null, static::class)->update($sets); }
  public static function deletes(): ?int { return Builder::create(null, static::class)->delete(); }

  public static function close(): bool { return Connection::close(); }

  public static function where(...$args): Builder { return Builder::create(null, static::class)->where(...$args); }
  public static function whereIn(string $key, array $vals): Builder { return Builder::create(null, static::class)->whereIn($key, $vals); }
  public static function in(string $key, array $vals): Builder { return Builder::create(null, static::class)->whereIn($key, $vals); }
  public static function whereNotIn(string $key, array $vals): Builder { return Builder::create(null, static::class)->whereNotIn($key, $vals); }
  public static function notIn(string $key, array $vals): Builder { return Builder::create(null, static::class)->whereNotIn($key, $vals); }
  public static function whereBetween(string $key, $val1, $val2): Builder { return Builder::create(null, static::class)->whereBetween($key, $val1, $val2); }
  public static function between(string $key, $val1, $val2): Builder { return Builder::create(null, static::class)->whereBetween($key, $val1, $val2); }

  public function hasMany(string $class, ?string $fk = null, ?string $pk = Model::PRIMARY_ID): Builder { return static::_has('all', $this, $class, $fk, $pk); }
  public function hasOne(string $class, ?string $fk = null, ?string $pk = Model::PRIMARY_ID): Builder { return static::_has('one', $this, $class, $fk, $pk); }
  public function belongsTo(string $class, ?string $fk = null, ?string $pk = Model::PRIMARY_ID): Builder { return static::_belongs('one', $this, $class, $fk, $pk); }
  public function belongsToMany(string $class, ?string $fk = null, ?string $pk = Model::PRIMARY_ID): Builder { return static::_belongs('all', $this, $class, $fk, $pk); }

  public static function relation(string ...$args): Builder { return Builder::create(null, static::class)->relation(...$args); }
