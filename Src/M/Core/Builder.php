...
final class Builder {
  ...
  public function all(): array { return $this->_runSelects(); }
  public function one(...$args): ?Model { return $this->where(...$args)->limit(1)->_runSelect(); }
  public function first(...$args): ?Model { return $this->where(...$args)->limit(1)->_runSelect(); }
  public function last(...$args): ?Model { return $this->where(...$args)->_reverseOrder()->limit(1)->_runSelect(); }
  ...
  public function delete(): ?int { return $this->_setType(self::_TYPE_DELETE)->_execute(); }
  ...
  public function or(...$args): self { return $this->orWhere(...$args); }
  public function orWhereIn(string $key, array $vals): self { return $this->orWhere($key, 'IN', $vals); }
  public function orIn(string $key, array $vals): self { return $this->orWhereIn($key, $vals); }
  public function orWhereNotIn(string $key, array $vals): self { return $this->orWhere($key, 'NOT IN', $vals); }
  public function orNotIn(string $key, array $vals): self { return $this->orWhereNotIn($key, $vals); }
  public function orWhereBetween(string $key, $val1, $val2): self { return $this->orWhere($key, 'BETWEEN', [$val1, $val2]); }
  public function orBetween(string $key, $val1, $val2): self { return $this->orWhereBetween($key, $val1, $val2); }
