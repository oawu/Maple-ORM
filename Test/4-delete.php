...
function resetDeleteDate() {
  \M\Delete\User::truncate();
  \M\Delete\User::creates([
...
$count = \M\Delete\User::deletes();
if ($count != 3) {
  throw new Exception();
}
if (\M\Delete\User::count() != 0) {
  throw new Exception();
}

resetDeleteDate();
$count = \M\Delete\User::where('id', '>', 1)->delete();
if ($count != 2) {
  throw new Exception();
}
if (\M\Delete\User::count() != 1) {
  throw new Exception();
}
if (\M\Delete\User::last()->id != 1) {
  throw new Exception();
}

resetDeleteDate();
$count = \M\Delete\User::where('id', '>', 10)->delete();
if ($count != 0) {
  throw new Exception();
}
if (\M\Delete\User::last()->id != 3) {
  throw new Exception();
}
